  ...
  return (
    <div className="profile-page">
      ...
      <ProfileHeader
        ...
        onMyPostsClick={() => setActiveTab('myPosts')}
        onAllPostsClick={() => setActiveTab('allPosts')}
      />
      ...
      {activeTab === 'myPosts' && <MyPost loggedInUserId={user.id} />}
      {activeTab === 'allPosts' && <AllPost loggedInUserId={user.id} />}
    </div>
  );
};
